package me.panxin.plugin.idea.jumpcontroller.toolwindow;
...
import me.panxin.plugin.idea.jumpcontroller.action.RefreshCacheAction;
...
public class SearchToolWindowFactory implements ToolWindowFactory, DumbAware {
    ...
    private class SearchToolWindowContent {
        ...
        private JPanel startSearch(List<ControllerInfo> controllerInfos) {
            ...
            searchField.getDocument().addDocumentListener(new DocumentListener() {
                ...
                private void performSearch(List<ControllerInfo> controllerInfos) {
...
//            searchPanel.add(hideToolWindowButton);
    ...
    private static void showControllerInfo(List<ControllerInfo> controllerInfos, JTextArea resultTextArea) {
    ...
    private static List<ControllerInfo> searchControllerInfos(List<ControllerInfo> controllerInfos, String searchText) {
        return controllerInfos.stream()
                .filter(info -> isMatched(info, searchText))
                .collect(Collectors.toList());
    }
    private static void navigateToFirstControllerCode(List<ControllerInfo> controllerInfos, String searchText) {
